...
class Profile(models.Model):
    ...
    past_edu_details = models.ForeignKey('Past_Education_Details', on_delete=models.CASCADE, null=True, blank=True)
    current_edu_details = models.ForeignKey('Current_Education_Details', on_delete=models.CASCADE, null=True, blank=True)
    other_details = models.ForeignKey('Other_Details', on_delete=models.CASCADE, null=True, blank=True)
    def __str__(self):
